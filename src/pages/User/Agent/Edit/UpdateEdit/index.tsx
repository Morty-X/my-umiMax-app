import {
  updateAgentApi,
  type IUpdateAgentParams,
} from '@/services/user/ProxyOfList/Agent/Edit/UpdateEdit/api';
...
const UpdateAgent = () => {
  ...
  /** 表单提交后的回调函数 */
  const onFinish = (values: IUpdateAgentParams) => {
    console.log('提交数据:', values);
    // 这里添加修改代理的逻辑
    updateAgentApi(values)
      .then((result) => {
    ...
    <>
      ...
      >
        ...
        <Form
          ...
          layout="vertical"
          initialValues={{
            status: Number(queryParamsObj.status),
            agentAccount: queryParamsObj.agentAccount,
